        ...
        {/* <div className="fixed -right-[150px]">
          <div className="flex">
            <div className="bg-white py-[30px] w-[70px] px-[10px] rounded-tl-[20px] rounded-bl-[20px]">
              <div>
                <Link href={`${get(basicInfos, "data.company_telegram")}`}>
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 25 24"
              ...
              <div className="my-[8px] max-w-[50px] !w-full h-[2px] !bg-[#037582]"></div>

              <div>
                <Link href={`${get(basicInfos, "data.company_instagram")}`}>
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 25 24"
              ...
              <div>
                <Link href={`${get(basicInfos, "data.company_facebook")}`}>
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 25 24"
              ...
              <div>
                <Link href={`${get(basicInfos, "data.company_youtube")}`}>
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 36 36"
              ...
              <div>
                <Link href={`${get(basicInfos, "data.company_linkedin")}`}>
                  <svg
                    width="36"
                    height="36"
                    viewBox="0 0 36 36"
